...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("C Language");

        jLabel3.setText("C++ LAnguage");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String cplus=jTextField3.getText();
        String java=jTextField4.getText();
        String dbms=jTextField5.getText();
        String python=jTextField6.getText();
        try{
            ...
            if(rs.next())
            {
                st.executeUpdate("insert into result (rollNo,c,cplus,java,dbms,python)values('"+rollNo+"','"+c+"','"+cplus+"','"+java+"','"+dbms+"','"+python+"')");
            ...
            {
                JOptionPane.showMessageDialog(null,"Roll Number is not exist in our data");
                setVisible(false);
                new insertNewResult().setVisible(true);
            }
        }
